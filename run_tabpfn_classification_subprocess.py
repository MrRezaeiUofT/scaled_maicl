#!/usr/bin/env python3
"""
Subprocess wrapper for TabPFN classification to isolate crashes.
...
if __name__ == '__main__':
    if len(sys.argv) != 5:
        print("Usage: run_tabpfn_classification_subprocess.py <X_train.csv> <y_train.npy> <X_test.csv> <output.json>", file=sys.stderr)
        sys.exit(1)
