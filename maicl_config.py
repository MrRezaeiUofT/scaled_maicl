...
ENCODER_BATCH_SIZE = 2000  # Batch size for encoding residual samples (None = no batching, all samples in one prompt)
...
MAX_FEATURES_IN_EXAMPLE = 5  # Maximum features to show in examples
